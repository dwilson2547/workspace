...
A desktop task queue manager with a React frontend and an Electron/Node.js backend. The application manages file processing tasks through manual queuing and automated workflow triggers.

## Technology Stack

- **Frontend**: React with TypeScript (shared between backends)
- **Backend**: Electron with Node.js (fallback, more stable WebView)
