part diagrams can be found by config starting from here: yamaha-motor.com/parts

Goal here is to categorize and persist all yamaha parts for an interchange lookup 
