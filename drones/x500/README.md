...
| RC receiver | RadioMaster RP3 ELRS | bind phrase `dwdrones` ([rx setup](../docs/topics/elrs/rx-x500-rp3.md) · [pairing](../docs/topics/elrs/pairing-x500.md)); not yet installed |
